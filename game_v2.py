...
Computer makes and predicts a number itself 
"""
...
def random_predict(number:int=1) -> int:
    ...
    Args:
        number (int, optional): A number to predict. Defaults to 1.
...
def score_game(random_predict) -> int:
    """How many attempts in average per 1000 times does it take to predict a number
